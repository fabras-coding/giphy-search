...
import { DiretivaCommonModuleRoutingModule } from './diretiva-common-module.module-routing.module';
...
exports: [],
declarations: [DiretivaCommonModuleComponent, NgStyleExemploComponent, NgClassExemploComponent, NgSwitchExemploComponent],
})
